    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-6 relative z-10">
        ...
        <motion.div
          ...
          className="relative w-[140px] h-[140px] sm:w-[200px] sm:h-[200px] mt-16 sm:mt-24 mb-2 sm:mb-4 flex items-center justify-center"
        >
          ...
          <div className="absolute z-20 w-[85%] h-[85%] flex items-center justify-center pointer-events-none">
            <img
              src={swiftersLogo}
              alt="Swifters Logo"
              className="w-full h-full scale-[1.8] object-contain drop-shadow-[0_0_20px_rgba(0,255,102,0.5)]"
              style={{
